...
plt.imshow(pix4)
plt.axis('off')
plt.title('pictures of baby', fontsize=10)              # 조카 이미지 출력

plt.subplot(143)
plt.imshow(pix5)
plt.axis('off')
plt.title('70% blended', fontsize=10)                   # 두 개의 조카 이미지를 70% 합성한 이미지 출력

plt.subplot(144)
plt.imshow(pix6)
plt.axis('off')
plt.title('30% blended', fontsize=10)                   # 두 개의 조카 이미지를 30% 합성한 이미지 출력
plt.show()